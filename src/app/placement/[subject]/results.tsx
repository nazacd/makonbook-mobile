      ...
      <SafeAreaView className="flex-1">
        <ScrollView className="flex-1">
          <View className="gap-6 p-6">
            <View className="items-center gap-2 rounded-2xl bg-brand p-8">
              <Text className="text-center text-sm font-semibold uppercase tracking-wide text-white/70">
            ...
            <View className="gap-3">
              <Text className="text-base font-semibold text-black dark:text-white">Question Review</Text>
